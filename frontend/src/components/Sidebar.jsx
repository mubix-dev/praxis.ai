    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="md:hidden fixed top-4 left-4 z-40 p-2 rounded-lg bg-white/10 hover:bg-white/15 cursor-pointer"
        >
      ...
      >
        ...
        {/* fixed-width inner wrapper so content doesn't squish while animating */}
